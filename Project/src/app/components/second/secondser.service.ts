...
export class SecondserService {
  ...
  saveFormData(formData: any, addictName: String): Observable<any> {
    ...
    return this.http.post( `${this.apiUrl}/${addictName}`, { ...formData, component: 'second' });
  }
