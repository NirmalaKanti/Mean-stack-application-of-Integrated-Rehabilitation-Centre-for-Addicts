...
// --------------------------------------------
  ...
  constructor(
    ...
    private page21serviceService: Page21serviceService,
  ...
  onSubmit() {
    if (this.formData.valid) {
      ...
      this.addictName = this.sharedService.getAddictName();
      // const dataToSend = { ...this.formData.value, component: 'page21' };

      this.page21serviceService.saveFormData(this.formData.value, this.addictName).subscribe(
        (response) => {
  ...
  fetchDataByAddictName() {
    if (this.addictName) {
      this.page21serviceService.getFormDataByAddictName(this.addictName).subscribe(
        (data) => {
  ...
  navigateToPage22Page() {
    // Only navigate to the page22 page if data is fetched
    if (this.dataFetched) {
      this.router.navigate(['../page22'], { relativeTo: this.route });
    }
  }
